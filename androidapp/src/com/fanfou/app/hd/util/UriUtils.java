...
public abstract class UriUtils {
	 ...
	 * sets.
	 * <p>
	 * <strong>Note</strong> that this method does not support fragments (
	 * {@code #}), as these are not supposed to be sent to the server, but
	 * retained by the client.
	 * 
	 * @param httpUrl
	 *            the HTTP URL to be encoded
	 * @param encoding
	 *            the character encoding to encode to
	...
	/**
	 * Encodes the given source URI components into an encoded String. All
	 * various URI components are optional, but encoded according to their
	 ...
	 *             when the given encoding parameter is not supported
	 */
	public static String encodeUriComponents(String scheme, String authority,
