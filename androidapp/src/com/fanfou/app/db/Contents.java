...
public final class Contents {
	...
	public static interface UserInfo extends BasicColumns {
		...
		public static final String COLUMNS[] = { _ID, ID, REAL_ID, OWNER_ID,
				NAME, SCREEN_NAME, LOCATION, GENDER, BIRTHDAY, DESCRIPTION,
				...
				LAST_STATUS_ID, LAST_STATUS_TEXT, TYPE, TIMESTAMP, };

		public static final String CREATE_TABLE = "create table " + TABLE_NAME
				+ " ( " + _ID + " integer primary key autoincrement, " + ID
				+ " text not null, " + REAL_ID + " long not null," + NAME
	...
	public static interface StatusInfo extends BasicColumns {
		...
		public static final Uri CONTENT_URI = Uri.parse("content://"
				+ AUTHORITY + "/statuses");
		// public static final Uri PUBLIC_URI=Uri.parse("content://" + AUTHORITY
		// + "/public");
		...
		public static final String COLUMNS[] = { _ID, ID, REAL_ID, OWNER_ID,
				CREATED_AT, TEXT, SOURCE, TRUNCATED, IN_REPLY_TO_STATUS_ID,
				IN_REPLY_TO_USER_ID, FAVORITED, IN_REPLY_TO_SCREEN_NAME,
				PHOTO_IMAGE_URL, PHOTO_THUMB_URL, PHOTO_LARGE_URL, USER_ID,
				USER_SCREEN_NAME, USER_PROFILE_IMAGE_URL, TYPE, IS_READ,

				IS_THREAD, HAS_PHOTO, SIMPLE_TEXT, SPECIAL, TIMESTAMP,

		};

		static final String STATUS_SQL = " (" + _ID
				+ " integer primary key autoincrement, " + CREATED_AT
				+ " integer not null, " + ID + " text not null, " + REAL_ID
				+ " long not null," + OWNER_ID + " text, " + TEXT
				+ " text not null, " + SOURCE + " text not null, " + TRUNCATED
				+ " boolean not null, "
				...
				+ IS_THREAD + " boolean not null, " + HAS_PHOTO
				+ " boolean not null, " + SIMPLE_TEXT + " text not null, "
				+ SPECIAL + " boolean not null, " + TIMESTAMP
				+ " integer not null, " + "unique ( " + ID + "," + TYPE + ","
				+ OWNER_ID + ") on conflict ignore );";
	...
	public static interface DirectMessageInfo extends BasicColumns {
		...
		public static final String COLUMNS[] = { _ID, ID, REAL_ID, OWNER_ID,
				TEXT, CREATED_AT, SENDER_ID, SENDER_SCREEN_NAME, RECIPIENT_ID,
				RECIPIENT_SCREEN_NAME, SENDER_PROFILE_IMAGE_URL,
				RECIPIENT_PROFILE_IMAGE_URL, TYPE, TIMESTAMP,
		...
		public static final String CREATE_TABLE = "create table " + TABLE_NAME
				+ " (" + _ID + " integer primary key autoincrement, " + ID
				+ " text not null, " + REAL_ID + " long not null," + OWNER_ID
				+ " text , " + TEXT + " text not null, " + CREATED_AT
				+ " integer not null, " + SENDER_ID + " text not null, "
				+ SENDER_SCREEN_NAME + " text not null, " + RECIPIENT_ID
				+ " text not null, " + RECIPIENT_SCREEN_NAME
				+ " text not null, " + SENDER_PROFILE_IMAGE_URL
				+ " text not null, " + RECIPIENT_PROFILE_IMAGE_URL
				+ " text not null, " + TYPE + " integer not null, " + TIMESTAMP
				+ " integer not null, "

				+ THREAD_USER_ID + " text not null, " + THREAD_USER_NAME
				+ " text not null, " + IS_READ + " boolean not null, "
