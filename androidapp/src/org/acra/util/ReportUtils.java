...
public final class ReportUtils {
	...
	public static String getApplicationFilePath(Context context) {
		...
		Log.w(ACRA.LOG_TAG, "Couldn't retrieve ApplicationFilePath for : "
	...
	public static String getDisplayDetails(Context context) {
		try {
			...
			Log.w(ACRA.LOG_TAG, "Couldn't retrieve DisplayDetails for : "
					+ context.getPackageName(), e);
	...
	public static String getCrashConfiguration(Context context) {
		try {
			...
			Log.w(ACRA.LOG_TAG, "Couldn't retrieve CrashConfiguration for : "
					+ context.getPackageName(), e);
