...
public class ACRA {
     ...
     */
    public static final ReportField[] DEFAULT_REPORT_FIELDS = { REPORT_ID, APP_VERSION_CODE, APP_VERSION_NAME,PHONE_MODEL, BRAND, PRODUCT, ANDROID_VERSION, BUILD, TOTAL_MEM_SIZE, AVAILABLE_MEM_SIZE,
    STACK_TRACE, DISPLAY, USER_COMMENT, LOGCAT};
    
    public static final ReportField[] DEFAULT_REPORT_FIELDS_BACKUP = { REPORT_ID, APP_VERSION_CODE, APP_VERSION_NAME, PACKAGE_NAME,
