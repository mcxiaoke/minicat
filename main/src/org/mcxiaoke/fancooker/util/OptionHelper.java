...
public final class OptionHelper {
	...
	public final static void saveInt(String key, int value) {
		Editor sp = AppContext.getPreferences().edit();
		sp.putInt(key, value);
		sp.commit();
	}
	...
	public final static int readInt(String key, int defValue) {
		int res = AppContext.getPreferences().getInt(key, defValue);
		return res;
	}

	public final static boolean readBoolean(String key, boolean defValue) {
		boolean res = AppContext.getPreferences().getBoolean(key, defValue);
		return res;
	}

	public final static String readString(String key, String defValue) {
		String res = AppContext.getPreferences().getString(key, defValue);
		return res;
	}

	public final static int parseInt(String key) {
		String res = AppContext.getPreferences().getString(key, "-1");
		return Integer.parseInt(res);
	}

	public final static int parseInt(Context context, int resId) {
		String res = AppContext.getPreferences().getString(context.getString(resId),
				"-1");
		return Integer.parseInt(res);
	}

	public final static int parseInt(String key, String defaultValue) {
		String res = AppContext.getPreferences().getString(key, defaultValue);
		return Integer.parseInt(res);
	}
	...
	public final static int readInt(Context context, int resId, int defValue) {
		int res = AppContext.getPreferences().getInt(context.getString(resId),
				defValue);
		return res;
	}
	...
	public final static boolean readBoolean(Context context, int resId,
			boolean defValue) {
		boolean res = AppContext.getPreferences().getBoolean(context.getString(resId),
				defValue);
		return res;
	}
