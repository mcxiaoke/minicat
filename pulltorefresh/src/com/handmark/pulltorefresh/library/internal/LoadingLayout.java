...
public class LoadingLayout extends FrameLayout {
	...
	public LoadingLayout(Context context, final int mode, String releaseLabel, String pullLabel,
		...
		if (attrs.hasValue(R.styleable.PullToRefresh_pullHeaderTextColor)) {
			final int color = attrs.getColor(R.styleable.PullToRefresh_pullHeaderTextColor, Color.BLACK);
			setTextColor(color);
		}
	}
